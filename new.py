...
desdir='D:\pycharm_community\python_workspace\canny_detection\canny/'
path=os.listdir(rootdir)
for file in path:
    imgname=os.path.join(rootdir,file)
    ...
    # plt.axis('off')
    # # plt.show()
    # plt.savefig(desdir+file)
    cv2.imwrite(desdir+file,DT*255)